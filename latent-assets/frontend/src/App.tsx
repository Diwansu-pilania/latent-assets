      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <section className="space-y-3">
          ...
          <div
            ...
            className={`flex flex-col items-center justify-center gap-2 w-full py-10 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${dragging ? "border-indigo-500 bg-indigo-500/10" : "border-zinc-700 hover:border-zinc-500 bg-zinc-900/50"
              }`}
          >
